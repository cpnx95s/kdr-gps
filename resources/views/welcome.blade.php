                        ...
                        <div class="col-md-6 pr-0">
                            <div class="card-body border-right border-bottom p-3 h-100">
                                <div class="d-flex flex-row bd-highlight pt-2">
                                    ...
                                    <div class="pl-3">
                                        <div class="mb-2">
                                            <a href="https://laravel.com/docs" class="h4 font-weight-bolder text-dark">Documentation</a>
                                        </div>
                        ...
                        <div class="col-md-6 pl-0">
                            <div class="card-body border-bottom p-3 h-100">
                                <div class="d-flex flex-row bd-highlight pt-2">
                                    ...
                                    <div class="pl-3">
                                        <div class="mb-2">
                                            <a href="https://laracasts.com" class="h4 font-weight-bolder text-dark">Laracasts</a>
                                        </div>
                                        <p class="text-muted small">
                            ...
                            <div class="card-body border-right p-3 h-100">
                                <div class="d-flex flex-row bd-highlight pt-2">
                                    ...
                                    <div class="pl-3 text-sm">
                                        <div class="mb-2">
                                            <a href="https://laravel-news.com/" class="h4 font-weight-bolder text-dark">Laravel News</a>
                                        </div>
                                        <p class="text-muted small">
                        ...
                        <div class="col-md-6 pl-0">
                            <div class="card-body p-3 h-100">
                                <div class="d-flex flex-row bd-highlight pt-2">
                                    ...
                                    <div class="pl-3">
                                        <div class="mb-2">
                                            <span class="h4 font-weight-bolder text-dark">Vibrant Ecosystem</span>
                                        </div>
                                        <p class="text-muted small">
