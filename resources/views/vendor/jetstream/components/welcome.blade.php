                                    ...
                                    <div id="his_set"
                                        ...
                                        <div>
                                            <table style="width: 100%;">
                                                <tbody>
                                                    <tr>
                                                        <td><input id="dateStart" type="text"
                                                                class="form-control hasDatepicker"
                                                                placeholder="yyyy-mm-dd" onkeydown="return false;"
                                                                disabled="disabled"></td>
                                                        <td width="68"><select id="hourStart" class="form-control"
                                                                disabled="disabled">
                                                                <option>00</option>
                                                                <option>01</option>
                                                                <option>02</option>
                                                        ...
                                                        <td width="68"><select id="minuteStart" class="form-control"
                                                                disabled="disabled">
                                                                <option>00</option>
                                                                <option>01</option>
                                                                <option>02</option>
                                        ...
                                        <div>
                                            <table style="width: 100%;">
                                                <tbody>
                                                    <tr>
                                                        <td><input id="dateStop" type="text"
                                                                class="form-control hasDatepicker"
                                                                placeholder="yyyy-mm-dd" onkeydown="return false;"
                                                                disabled="disabled"></td>
                                                        <td width="68"><select id="hourStop" class="form-control"
                                                                disabled="disabled">
                                                                <option>00</option>
                                                                <option>01</option>
                                                                <option>02</option>
                                                        ...
                                                        <td width="68"><select id="minuteStop" class="form-control"
                                                                disabled="disabled">
                                                                <option>00</option>
                                                                <option>01</option>
                                                                <option>02</option>
                                        ...
                                        <div style="margin-top:10px;">
                                            <table style="width:100%;">
                                                <tbody>
                                                    <tr>
                                                        <td><button id="btn_get_history" class="btn btn-success"
                                                                style="width:100%;">ตกลง</button></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
